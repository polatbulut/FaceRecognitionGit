...
class Main:
    ...
    def load_images(self):
        ...
        # camera_count = self.count_connected_cameras()
        self.process(0)

    def commit_to_database(self, input_name, input_time):
        query = f"UPDATE bsy_SicilYuzOkutmaLog SET Datetime = '{input_time}', MerdivenID = '{self.ship_id}', DeviceID = '{self.device_id}' WHERE SicilID = {input_name}"
        print("\n" + query)
            ...
            for face_loc, name in zip(face_location, face_name):
                ...
                if name != "Unknown":
                    if name not in known_names:
                        ...
                        self.commit_to_database(name, current_datetime)
